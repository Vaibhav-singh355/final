...
export default function AthleticPerformancePlanPage() {
  const planDetails = {
    title: " Long-Term Lifestyle Rebuild",
    ...
    popular: false,
    features: [
      "The highest level of personalization, depth, and accountability. ",
      " Focus on mastering habits, healing imbalances, and building a lifestyle that supports vitality, longevity, and strength—both physical and emotional.",
      "This is not just about weight loss or fitness; it’s about building a resilient body and mindset through every season of life.",
      
      "flexible adjustments, detailed progress tracking, seasonal recalibration of plans, and full access to support.",
      "Program is ideal for anyone ready to reset and rewrite their health story for good.",
